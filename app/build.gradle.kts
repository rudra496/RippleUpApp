    ...
    buildTypes {
        release {
            ...
            signingConfig = if (System.getenv("KEYSTORE_B64") != null) {
                ...
                null // unsigned release locally; CI provides the keystore
            }
        }
        debug {
...
dependencies {
    ...
    // CameraX (live camera preview for QR scan + photo capture)
    ...
    // cloud (Supabase REST + Google sign-in + secure session storage)
